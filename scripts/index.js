...
profileModalBoxClose.addEventListener("click", () => { closeModal(profileModalDisplay) });
cardModalBoxOpen.addEventListener("click", () => { openModal(cardModalDisplay) });
cardModalBoxClose.addEventListener("click", () => { closeModal(cardModalDisplay) });
...
function getCardElement(data) {
    ...
    cardLikeButtom.addEventListener("click", () => cardLikeButtom.classList.toggle("elements__like-buttom-black"));
...
imageModalClose.addEventListener("click", () => { closeModal(imageView) });
